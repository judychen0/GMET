...
void xMerge_triboson(Int_t year){
  TString rootname[10];
  TFile *fopen, *fout;

  Int_t entries = 1.0;
  Float_t outentries = 0.;
  Float_t scale[ntriBoson] = {0};
  ...
  Float_t mcXsec[10] = {0.3369, 0.07876};//[WWG, WZG]
  
  if(year==2016){
    rootname[0] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220318/summer16/mc/triboson/job_summer16_WWG/output_ggtree.root";
    rootname[1] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220318/summer16/mc/triboson/job_summer16_WZG/output_ggtree.root";
  }
  else if(year==2017){
    rootname[0] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220318/fall17/mc/triboson/job_fall17_WWG/output_ggtree.root";
    rootname[1] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220318/fall17/mc/triboson/job_fall17_WZG/output_ggtree.root";
  }
  else if(year==2018){
    rootname[0] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220318/autumn18/mc/triboson/job_autumn18_WWG/output_ggtree.root";
    rootname[1] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220318/autumn18/mc/triboson/job_autumn18_WZG/output_ggtree.root";
  }

  for(Int_t i=0; i<ntriBoson; i++){
  ...
  fout = new TFile("output_merge_triBoson.root", "RECREATE");
  fout->cd();
