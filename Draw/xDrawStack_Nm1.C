...
void xDrawStack_Nm1(Int_t year){
 ...
 Float_t lumi16 = 36.33;
  ...
  for(Int_t jj=0; jj<2; jj++){
    ...
    HS_MET_Nm1[jj]->SetMaximum(10000000);
    ...
    for(Int_t ifile=0; ifile<nfile; ifile++){
      lhs->AddEntry(H_MET_Nm1[i][jj], ltext[i], "F");
    }
    ...
    lhs->Clear();
    for(Int_t ifile=0; ifile<nfile; ifile++){
      lhs->AddEntry(H_dphoMETPhi_Nm1[i][jj], ltext[i], "F");
    }
    ...
    lhs->Clear();
    for(Int_t ifile=0; ifile<nfile; ifile++){
      lhs->AddEntry(H_njet_Nm1[i][jj], ltext[i], "F");
    }
    ...
    lhs->Clear();
    for(Int_t ifile=0; ifile<nfile; ifile++){
      lhs->AddEntry(H_jetpt_Nm1[i][jj], ltext[i], "F");
    }
    ...
    lhs->Clear();
    for(Int_t ifile=0; ifile<nfile; ifile++){
      lhs->AddEntry(H_djetMETPhi_Nm1[i][jj], ltext[i], "F");
    }
