...
void xMerge_DYJet(Int_t year){
  ...
  if(year==2016){
    rootname[0] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220318/summer16/mc/DYJet/job_summer16_DYJetsToLL_m50_MG_HT200to400/output_ggtree.root";
    rootname[1] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220318/summer16/mc/DYJet/job_summer16_DYJetsToLL_m50_MG_HT400to600/output_ggtree.root";
    rootname[2] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220318/summer16/mc/DYJet/job_summer16_DYJetsToLL_m50_MG_HT600to800/output_ggtree.root";
    rootname[3] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220318/summer16/mc/DYJet/job_summer16_DYJetsToLL_m50_MG_HT800to1200/output_ggtree.root";
    rootname[4] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220318/summer16/mc/DYJet/job_summer16_DYJetsToLL_m50_MG_HT1200to2500/output_ggtree.root";
    rootname[5] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220318/summer16/mc/DYJet/job_summer16_DYJetsToLL_m50_MG_HT2500toInf/output_ggtree.root";
  }
  else if(year==2017){
    rootname[0] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220318/fall17/mc/DYJet/job_fall17_DYJetsToLL_m50_MG_HT200to400/output_ggtree.root";
    rootname[1] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220318/fall17/mc/DYJet/job_fall17_DYJetsToLL_m50_MG_HT400to600/output_ggtree.root";
    rootname[2] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220318/fall17/mc/DYJet/job_fall17_DYJetsToLL_m50_MG_HT600to800/output_ggtree.root";
    rootname[3] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220318/fall17/mc/DYJet/job_fall17_DYJetsToLL_m50_MG_HT800to1200/output_ggtree.root";
    rootname[4] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220318/fall17/mc/DYJet/job_fall17_DYJetsToLL_m50_MG_HT1200to2500/output_ggtree.root";
    rootname[5] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220318/fall17/mc/DYJet/job_fall17_DYJetsToLL_m50_MG_HT2500toInf/output_ggtree.root";
  }
  else if(year==2018){
    rootname[0] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220318/autumn18/mc/DYJet/job_autumn18_DYJetsToLL_m50_MG_HT200to400/output_ggtree.root";
    rootname[1] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220318/autumn18/mc/DYJet/job_autumn18_DYJetsToLL_m50_MG_HT400to600/output_ggtree.root";
    rootname[2] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220318/autumn18/mc/DYJet/job_autumn18_DYJetsToLL_m50_MG_HT600to800/output_ggtree.root";
    rootname[3] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220318/autumn18/mc/DYJet/job_autumn18_DYJetsToLL_m50_MG_HT800to1200/output_ggtree.root";
    rootname[4] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220318/autumn18/mc/DYJet/job_autumn18_DYJetsToLL_m50_MG_HT1200to2500/output_ggtree.root";
    rootname[5] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220318/autumn18/mc/DYJet/job_autumn18_DYJetsToLL_m50_MG_HT2500toInf/output_ggtree.root";
  }
  ...
  Double_t METbin[20] = {0, 100, 150, 200, 250, 300, 400, 500, 650, 800, 1200};//10bins
  Double_t phibin[20] = {-TMath::Pi(), -2.5, -2, -1.4, -0.8, 0.0, 0.8, 1.4, 2, 2.5, TMath::Pi()};//10bins
  Double_t dphibin[20] = {-TMath::Pi(), -2.7, -2.5, -2.3, -2, -1.4, -1.0, -0.6, 0.0, 0.6, 1.0, 1.4, 2, 2.3, 2.5, 2.7, TMath::Pi()};//16bins
  ...
  for(Int_t j=0; j<2; j++){
    ...
    h_phoEB_pt_phoCentral[j] = new TH1F(Form("h_phoEB_pt_phoCentral_%i", j), "phoCentral cut", 14, ptbin);
    ...
    h_dphoMETPhi_Nm1[j] = new TH1F(Form("h_dphoMETPhi_Nm1_%i", j), "deltaPhi of pho and MET N-1 cut", 16, dphibin);
    h_dphoMETPhi_cut[j] = new TH1F(Form("h_dphoMETPhi_cut_%i", j), "deltaPhi of pho and MET N cut", 16, dphibin);
        
    h_ptoverMET_cut[j] = new TH1F(Form("h_ptoverMET_cut_%i", j), "phoEB pt/MET N cut", 20, 0, 4);
  ...
  for(Int_t ii=0; ii<2; ii++){
    h_djetMETPhi_Nm1[ii] = new TH1F(Form("h_djetMETPhi_Nm1_jet%i", ii), "djetMETPhi mindJMETPhi N-1 cut", 16, dphibin);
    h_djetMETPhi_cut[ii] = new TH1F(Form("h_djetMETPhi_cut_jet%i", ii), "djetMETPhi mindJMETPhi cut all", 16, dphibin);
    
    h_dr_phojet[ii] = new TH1F(Form("h_dr_phojet_jet%i", ii), "pho jet dr", 20, 0., 8);
    h_dEta_phojet[ii] = new TH1F(Form("h_dEta_phojet_jet%i", ii), "pho jet dEta", 20, 0., 8);
    h_dPhi_phojet[ii] = new TH1F(Form("h_dPhi_phojet_jet%i", ii), "pho jet dPhi", 16, dphibin);
  }

  Double_t massbin[20] = {0, 250, 350, 500, 600, 700, 800, 900, 1100, 1300, 1500, 2000, 5000};//12bins
  ...
  h_minJMETdPhi_Nm1 = new TH1F("h_minJMETdPhi_Nm1", "minJMETdPhi N-1", 16, dphibin);
  h_minJMETdPhi_cut = new TH1F("h_minJMETdPhi_cut", "minJMETdPhi N cut", 16, dphibin);
  h_dEta_jetjet_Nm1 = new TH1F("h_dEta_jetjet_Nm1", "jet jet dEta N-1", 20, 0., 8);
  h_dEta_jetjet_cut = new TH1F("h_dEta_jetjet_cut", "jet jet dEta N cut", 20, 0., 8);
  h_dPhi_jetjet_Nm1 = new TH1F("h_dPhi_jetjet_Nm1", "jet jet dPhi N-1", 16, dphibin);
  h_dPhi_jetjet_cut = new TH1F("h_dPhi_jetjet_cut", "jet jet dPhi N cut", 16, dphibin);
  h_dijetMass_cut = new TH1F("h_dijetMass_cut", "dijet mass N cut", 12, massbin);
  h_dijetMass_Nm1 = new TH1F("h_dijetMass_Nm1", "dijet mass N-1 cut", 12, massbin);
  ...
  h_jetjetZdPhi_cut = new TH1F("h_jetjetZdPhi_cut", "jetjet Z dPhi N cut", 16, dphibin);
  h_jetjetphodPhi_cut = new TH1F("h_jetjetphodPhi_cut", "jetjet pho dPhi N cut", 16, dphibin);
  ...
  h_dphoMETPhi_ptoverMET_CR = new TH1F("h_dphoMETPhi_ptoverMET_CR", "", 16, dphibin);
  h_minJMETdPhi_ptoverMET_CR = new TH1F("h_minJMETdPhi_ptoverMET_CR", "", 16, dphibin);
  h_dijetMass_ptoverMET_CR = new TH1F("h_dijetMass_ptoverMET_CR", "", 12, massbin);
  h_dEta_jetjet_ptoverMET_CR = new TH1F("h_dEta_jetjet_ptoverMET_CR", "", 20, 0., 8);
  ...
  for(Int_t i=0; i<nDYJet; i++){
    ...
    for(Int_t j=0; j<nhisto; j++){
      ...
      h_phoEB_pt_phoCentral[j]->Add((TH1F*)fopen->Get(Form("SMandVBS/h_phoEB_pt_phoCentral_%i", j)), scale[i]);
      ...
      h_ptoverMET_cut[j]->Add((TH1F*)fopen->Get(Form("SMandVBS/h_ptoverMET_cut_%i", j)), scale[i]);
	...
	h_jetpt_cut[j][ijet]->Add((TH1F*)fopen->Get(Form("dijet/h_jetpt_cut_%i_jet%i", j, ijet)), scale[i]);
	h_jetEta_cut[j][ijet]->Add((TH1F*)fopen->Get(Form("dijet/h_jetEta_cut_%i_jet%i", j, ijet)), scale[i]);
	h_jetPhi_cut[j][ijet]->Add((TH1F*)fopen->Get(Form("dijet/h_jetPhi_cut_%i_jet%i", j, ijet)), scale[i]);

      }

      h_djetMETPhi_Nm1[j]->Add((TH1F*)fopen->Get(Form("dijet/h_djetMETPhi_Nm1_jet%i", j)), scale[i]);
      h_djetMETPhi_cut[j]->Add((TH1F*)fopen->Get(Form("dijet/h_djetMETPhi_cut_jet%i", j)), scale[i]);
    
      h_dr_phojet[j]->Add((TH1F*)fopen->Get(Form("dijet/h_dr_phojet_jet%i",j)), scale[i]);
      h_dEta_phojet[j]->Add((TH1F*)fopen->Get(Form("dijet/h_dEta_phojet_jet%i", j)), scale[i]);
      h_dPhi_phojet[j]->Add((TH1F*)fopen->Get(Form("dijet/h_dPhi_phojet_jet%i", j)), scale[i]);
  ...
  for(Int_t jj=0; jj<2; jj++){
    h_djetMETPhi_Nm1[jj]->Write();
    h_djetMETPhi_cut[jj]->Write();

    h_dr_phojet[jj]->Write();
    h_dEta_phojet[jj]->Write();
    h_dPhi_phojet[jj]->Write();
    
    for(Int_t ii=0; ii<2; ii++){
      h_jetpt_cut[ii][jj]->Write();
      h_jetEta_cut[ii][jj]->Write();
      h_jetPhi_cut[ii][jj]->Write();
    }
  }
