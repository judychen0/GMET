...
void xMerge_DYJet(Int_t year){
  ...
  if(year==2016){
    rootname[0] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220105/summer16/mc/DYJet/job_summer16_DYJetsToLL_m50_MG_HT200to400/output_ggtree.root";
    rootname[1] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220105/summer16/mc/DYJet/job_summer16_DYJetsToLL_m50_MG_HT400to600/output_ggtree.root";
    rootname[2] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220105/summer16/mc/DYJet/job_summer16_DYJetsToLL_m50_MG_HT600to800/output_ggtree.root";
    rootname[3] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220105/summer16/mc/DYJet/job_summer16_DYJetsToLL_m50_MG_HT800to1200/output_ggtree.root";
    rootname[4] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220105/summer16/mc/DYJet/job_summer16_DYJetsToLL_m50_MG_HT1200to2500/output_ggtree.root";
    rootname[5] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220105/summer16/mc/DYJet/job_summer16_DYJetsToLL_m50_MG_HT2500toInf/output_ggtree.root";
  }
  else if(year==2017){
    rootname[0] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220105/fall17/mc/DYJet/job_fall17_DYJetsToLL_m50_MG_HT200to400/output_ggtree.root";
    rootname[1] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220105/fall17/mc/DYJet/job_fall17_DYJetsToLL_m50_MG_HT400to600/output_ggtree.root";
    rootname[2] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220105/fall17/mc/DYJet/job_fall17_DYJetsToLL_m50_MG_HT600to800/output_ggtree.root";
    rootname[3] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220105/fall17/mc/DYJet/job_fall17_DYJetsToLL_m50_MG_HT800to1200/output_ggtree.root";
    rootname[4] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220105/fall17/mc/DYJet/job_fall17_DYJetsToLL_m50_MG_HT1200to2500/output_ggtree.root";
    rootname[5] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220105/fall17/mc/DYJet/job_fall17_DYJetsToLL_m50_MG_HT2500toInf/output_ggtree.root";
  }
  else if(year==2018){
    rootname[0] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220105/autumn18/mc/DYJet/job_autumn18_DYJetsToLL_m50_MG_HT200to400/output_ggtree.root";
    rootname[1] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220105/autumn18/mc/DYJet/job_autumn18_DYJetsToLL_m50_MG_HT400to600/output_ggtree.root";
    rootname[2] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220105/autumn18/mc/DYJet/job_autumn18_DYJetsToLL_m50_MG_HT600to800/output_ggtree.root";
    rootname[3] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220105/autumn18/mc/DYJet/job_autumn18_DYJetsToLL_m50_MG_HT800to1200/output_ggtree.root";
    rootname[4] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220105/autumn18/mc/DYJet/job_autumn18_DYJetsToLL_m50_MG_HT1200to2500/output_ggtree.root";
    rootname[5] = "/data1/GMET/ana/ggNtuples102X/V10_06_00_20/220105/autumn18/mc/DYJet/job_autumn18_DYJetsToLL_m50_MG_HT2500toInf/output_ggtree.root";
  }
  ...
  TH1F* h_dr_jetjet_Nm1 = new TH1F("h_dr_jetjet_Nm1", "jet jet dR N-1", 20, 0., 8);
  TH1F* h_dEta_jetjet = new TH1F("h_dEta_jetjet", "jet jet dEta", 20, 0., 8);
  TH1F* h_dEta_jetjet_Nm1 = new TH1F("h_dEta_jetjet_Nm1", "jet jet dEta N-1", 20, 0., 8);
  TH1F* h_dPhi_jetjet = new TH1F("h_dPhi_jetjet", "jet jet dPhi", 30, -3.14, 3.14);
  TH1F* h_dijetMass_cut = new TH1F("h_dijetMass_cut", "dijet mass", 80, 0, 2000);
  TH1F* h_dijetMass_Nm1 = new TH1F("h_dijetMass_Nm1", "dijet mass N-1", 80, 0, 2000);

  TH1F* h_MET_phojetdR = new TH1F("h_MET_phojetdR", "MET cut phojetdR", 60, 0, 1200);
  TH1F* h_MET_jetjetdEta = new TH1F("h_MET_jetjetdEta", "MET cut jetjetdEta", 60, 0, 1200);
  TH1F* h_MET_jetjetdR = new TH1F("h_MET_jetjetdR", "MET cut jetjetdR", 60, 0, 1200);
  TH1F* h_MET_dijetMass = new TH1F("h_MET_dijetMass", "MET cut dijetMass", 60, 0, 1200);
  TH1F* h_MET_jetveto = new TH1F("h_MET_jetveto", "MET cut jetveto", 60, 0, 1200);
  ...
  for(Int_t i=0; i<nDYJet; i++){
    ...
    h_dr_jetjet_Nm1->Add((TH1F*)fopen->Get("h_dr_jetjet_Nm1"), scale[i]);
    h_dEta_jetjet->Add((TH1F*)fopen->Get("h_dEta_jetjet"), scale[i]);
    h_dEta_jetjet_Nm1->Add((TH1F*)fopen->Get("h_dEta_jetjet_Nm1"), scale[i]);
    h_dPhi_jetjet->Add((TH1F*)fopen->Get("h_dPhi_jetjet"), scale[i]);
    h_dijetMass_cut->Add((TH1F*)fopen->Get("h_dijetMass_cut"), scale[i]);
    h_dijetMass_Nm1->Add((TH1F*)fopen->Get("h_dijetMass_Nm1"), scale[i]);

    h_MET_phojetdR->Add((TH1F*)fopen->Get("h_MET_jetcut/h_MET_phojetdR"), scale[i]);
    h_MET_jetjetdEta->Add((TH1F*)fopen->Get("h_MET_jetcut/h_MET_jetjetdEta"), scale[i]);
    h_MET_jetjetdR->Add((TH1F*)fopen->Get("h_MET_jetcut/h_MET_jetjetdR"), scale[i]);
    h_MET_dijetMass->Add((TH1F*)fopen->Get("h_MET_jetcut/h_MET_dijetMass"), scale[i]);
    h_MET_jetveto->Add((TH1F*)fopen->Get("h_MET_jetcut/h_MET_jetveto"), scale[i]);
    ...
    for(Int_t j=0; j<nhisto; j++){
      ...
      h_phoEB_nvtx_210[j]->Add((TH1F*)fopen->Get(Form("nVtx/h_phoEB_nvtx_210_%i", j)), scale[i]);
      h_phoEB_nvtx_M[j]->Add((TH1F*)fopen->Get(Form("nVtx/h_phoEB_nvtx_M_%i", j)), scale[i]);
      h_phoEB_nvtx_leptonveto[j]->Add((TH1F*)fopen->Get(Form("nVtx/h_phoEB_nvtx_leptonveto_%i", j)), scale[i]);
      h_phoEB_nvtx_MET[j]->Add((TH1F*)fopen->Get(Form("nVtx/h_phoEB_nvtx_MET_%i", j)), scale[i]);
      h_phoEB_nvtx_dphoMETPhi[j]->Add((TH1F*)fopen->Get(Form("nVtx/h_phoEB_nvtx_dphoMETPhi_%i", j)), scale[i]);
      h_phoEB_nvtx_djetMETPhi[j]->Add((TH1F*)fopen->Get(Form("nVtx/h_phoEB_nvtx_djetMETPhi_%i", j)), scale[i]);
      h_phoEB_nvtx_jetveto[j]->Add((TH1F*)fopen->Get(Form("nVtx/h_phoEB_nvtx_jetveto_%i", j)), scale[i]);
  ...
  fout->mkdir("h_MET_jetcut");
  fout->cd("h_MET_jetcut");
