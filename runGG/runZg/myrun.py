...
with open(remotepath, "r") as filepath:
    ...
    for line in path:
        ...
        script += "\n"
        script += """/usr/bin/time parallel --progress --jobs 1 'root -L -l -b -q "xZg1.C+(\\\"{1}\\\", {2})"' :::: path.txt :::+ $isSig \n"""
        script += """/usr/bin/time parallel --progress --jobs 25 'root -L -l -b -q "xZg1.C+(\\\"{1}\\\", {2})"' :::: path.txt ::: $isSig \n"""
