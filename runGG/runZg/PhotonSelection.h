...
void pho_Nchselection(Int_t iWP, Int_t region, TreeReader &data, vector<int>& passed){
  //void pho_IDselection(Int_t iWP, TreeReader &data, vector<int>& passed){  
  //region = 0;
  passed.clear();
...
Int_t Nm2_sel(Int_t IDbit, Int_t ibit, Int_t ibit_nd){
  Int_t ncut = 17;
