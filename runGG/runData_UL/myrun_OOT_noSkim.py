...
with open(remotepath, "r") as filepath:
    ...
    for line in path:
        ...
        script += "\n"
        script += """/usr/bin/time parallel --progress --jobs 1 'root -l -b -q "xZgOOT.C+(\\\"{1}\\\")"' :::: path.txt :::+ 1  \n"""
        script += """/usr/bin/time parallel --progress --jobs 25 'root -l -b -q "xZgOOT.C+(\\\"{1}\\\")"' :::: path.txt  \n"""
